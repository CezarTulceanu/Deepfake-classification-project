...
Original file is located at
    https://colab.research.google.com/drive/1XwAu7raB5fUD7_XWuO8EyA31rvcJ93Ci
"""
...
#Triplam imaginile din clasa a 4-a iar pe celelalte doar le dublam pentru a antrena modeulul mai bine pe clasa a 4-a 
...
#Facem foarte putin data augmentation
...
def create_simple_cnn(input_shape, num_classes, l2_lambda=1e-4):
    ...
    #Am adaugat un branch secundar care preia din nou imaginile, le aplica un layer convolutional, apoi unul de AVGPooling, dupa care se 
    #concateneaza la branchul principal pentru a-i oferi modelului

    skip = layers.Conv2D(16, 3, activation='relu', padding='same')(inputs)
    skip = layers.AveragePooling2D(pool_size=(16, 16), strides=(16, 16))(skip) 
    skip = layers.Flatten()(skip)

    x = layers.Concatenate()([x, skip])

    #Am crescut numarul de neuroni din straturile de la final pentru a putea procesa ambele branch-uri
...
#Am setat o rata de decay a rate de invatare pentru ca aseasta sa creasca (am facut o greseala)
